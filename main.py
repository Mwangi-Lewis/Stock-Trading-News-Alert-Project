...
if abs(diff_percent) > 1:
    ...
    try:
        response_json = news_response.json()
        if "articles" in response_json:
            articles = response_json["articles"]
        else:
            print("Error: 'articles' key not found in the JSON response.")
    except ValueError:
        print("Error: Unable to decode JSON. The response may be empty or invalid.")
    ...
    for article in formatted_articles:
        ...
        # Email content
        subject = "Subject: Stock Alerts!\n"
        body = formatted_articles_str

        # Encode subject and body to UTF-8
